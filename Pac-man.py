...
player_images = []
for i in range(1, 5):
    player_images.append(pygame.transform.scale(pygame.image.load(f'Pacman Images/PLAYER/{i}.png'), (45, 45)))
blinky_img = pygame.transform.scale(pygame.image.load(f'Pacman Images/GHOST/blinky.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'Pacman Images/GHOST/pinky.png'), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(f'Pacman Images/GHOST/inky.png'), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(f'Pacman Images/GHOST/clyde.png'), (45, 45))
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
